...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 20 mars 2023 à 05:33
...
INSERT INTO `note` (`idNote`, `nomber`, `Unité_de_formation_IdFormation`) VALUES
(8, 14, 8),
(9, 12, 8),
(10, 15, 8),
(11, 18, 9),
...
INSERT INTO `unité_de_formation` (`IdFormation`, `nom_Unité_de_formation`, `Tableau_des_points_IdTableau_tableau`) VALUES
(8, 'TDI_2', 8),
(9, 'TDI_3', 8);
