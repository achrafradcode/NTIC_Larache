                                ...
                                <td >
                                    ...
                                    <td colspan="2" style="width: 100%;padding: 20px;">
                                        <div class="h-100">
                                            ...
                                            <input type="text"
                                                class="form-control w-100" name="Titre" id="Titre" aria-describedby="helpId" placeholder="">
                                            
                                            <label for="" class="form-label mt-3">Description de Article</label>
                                            <input type="text"
                                                class="form-control w-100" name="Description" id="Description" aria-describedby="helpId" placeholder="">
                            ...
                            <tbody class="table-group-divider">
                                ...
                                <script type="text/javascript">
                                    ...
                                    function fetchUser(){
                                        ...
                                        $.post("../inc/functions.inc.php", { function_name: "executeRequete",requet:"SELECT * from `articles_d'actualité` where `titre_de_l'actualité`='"+window.selected["titre_de_l'actualité"]+"';" }, function(d) {
                                    ...
                                    function confirmDelete(){
                                        $.post("../inc/functions.inc.php", { function_name: "executeRequete",msgSuccess:"Annonce supprimé avec succès",msgFaild:"Une erreur s'est produite",requet:"DELETE from `articles_d'actualité` where IdArticle='"+window.selected[0].IdArticle +"';" }, function(d) {
                                            // Handle the response here
                                    ...
                                    <td colspan="2" style="width: 100%;padding: 20px;">
                                        <div class="h-100">
                                            ...
                                            <div class="row">
                                                <div class="col-6    p-0 m-0">
                                                    <input type="text"
                                                    class="form-control rounded-start rounded-0 m-0 " disabled name="" id="old_Titre_De_Article" aria-describedby="helpId" placeholder="">
                                                </div>
                                                <div class="col-6    p-0 m-0">
                                                    <input type="text"
                                                    class="form-control rounded-end rounded-0  m-0 " name="Titre" id="Titre_De_Article" aria-describedby="helpId" placeholder="">
                                                </div>
                                            </div>
                                            <label for="" class="form-label mt-3">Description de Article</label>
                                            <div class="row">
                                                <div class="col-6    p-0 m-0">
                                                    <input type="text"
                                                    class="form-control rounded-start rounded-0 m-0 " disabled name="" id="old_Description_De_Article" aria-describedby="helpId" placeholder="">
                                                </div>
                                                <div class="col-6    p-0 m-0">
                                                    <input type="text"
                                                    class="form-control rounded-end rounded-0  m-0 " name="Description" id="Description_De_Article" aria-describedby="helpId" placeholder="">
                                                </div>
                                            </div>
                                            <label for="" class="form-label mt-3">Nom de l'editeur</label>
