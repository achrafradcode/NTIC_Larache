...
$(window).on("load",()=>{
  ...
  let viewer = document.getElementById('PDFFrame');
  ...
  $('#upload_image_background2').change(function(){
    ...
    else
    {
      showToast({
        type:"error",
        autoDismiss: true,
        message:"Cette type "+ext+" unacceptable"
    });
    }
  });
  ...
  function uploadFile(file ,i) {
    ...
    xhr.addEventListener('readystatechange', function(e) {
      ...
      previewFile($("#upload_image_file")[0].value);
  ...
  function previewFile(fileUrl) {
    ...
    $(viewer).attr("src", "/inc/"+decodeURIComponent(fileUrl));
